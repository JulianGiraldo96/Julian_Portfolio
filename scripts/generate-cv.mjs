...
<body>
  <div class="header">
    ...
    <p class="role-line">Product Designer (UX/UI) · Complex B2B SaaS · Full-Lifecycle Ownership · Design Systems · AI UX · Berlin, DE</p>
  ...
  <section>
    ...
    <div class="job">
      ...
      <ul>
        <li>Own design delivery across the full lifecycle on a complex B2B platform (13 modules, 40+ document types, 6 permission roles) with many interdependent flows and states, from discovery to final implementation and polish.</li>
        <li>Translate ambitious operational and business goals into intuitive, user-centered solutions; produce user flows, wireframes, high-fidelity mockups and interactive prototypes.</li>
        <li>Contribute to and maintain a scalable design system (components, patterns, design tokens) that keeps the entire UI consistent as the product grows.</li>
        <li>Run usability testing and data-driven experimentation with real users; rationalize decisions with data, research, user feedback loops and direct customer input. Transformed onboarding UX, cutting onboarding time by ~30%.</li>
        <li>Design AI-powered UX and Copilot-style features, and collaborate closely with engineering to scope, prioritize and define outcomes; I write frontend (Next.js) so prototypes are real and handoff is buildable.</li>
      </ul>
    </div>
  ...
  <section>
    ...
    <div class="skill-row"><div class="label">Domains</div><div class="val">B2B SaaS · Financial / Operational Tooling · Invoicing &amp; Accounting-adjacent Workflows · Cross-functional Squads (PM, Eng, Analysts)</div></div>
  </section>

      ...
      >
        <nav className={`mx-auto max-w-[1600px] flex items-center justify-between md:grid md:grid-cols-3 ${scrolled ? "text-foreground" : "text-white"}`}>
          <Link
            href="/"
            onClick={(e) => go(e, "#top")}
            className="font-mono text-[15px] md:text-[16px] tracking-[0.18em] uppercase justify-self-start"
            data-cursor-hover
          >
            Julian
          ...
          {/* Desktop links */}
          <ul className="hidden md:flex items-center justify-center gap-8 font-mono text-[13px] md:text-[15px] uppercase tracking-[0.18em]">
            {links.map((l) => (
              <li key={l.hash}>
                <a
          ...
          >
            ...
            >
              ...
              <motion.li
                ...
                className="mt-10 font-mono text-[13px] tracking-[0.18em] uppercase opacity-70"
              >
                <BerlinClock />
              </motion.li>
            </motion.ul>

    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-px border border-border bg-border overflow-hidden">
      {items.map((item, i) => (
        ...
        >
          ...
          <span className="mt-auto font-mono text-[9px] md:text-[10px] uppercase tracking-[0.2em] text-muted border-t border-border pt-4">
            {item.hint}
          </span>
        </motion.div>
      ))}
    ...
    >
      ...
      <div className="grid grid-cols-4 border-b border-border">
        {[
          ...
          <div
            key={i}
            className={`px-5 py-4 font-mono text-[9px] md:text-[10px] uppercase tracking-[0.2em] text-muted ${i < 3 ? "border-r border-border" : ""
              }`}
          >
            {p}
          </div>
...
function MoreWork() {
  return (
    <div className="mt-24 md:mt-40 px-6 md:px-10 border-t border-border pt-16 pb-8">
      <div className="mx-auto max-w-[1400px]">
        <div className="flex items-end justify-between mb-10 md:mb-14 font-mono text-[10px] md:text-[11px] uppercase tracking-[0.22em]">
          <span className="text-muted">

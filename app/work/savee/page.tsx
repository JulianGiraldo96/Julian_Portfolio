      ...
      <V2CaseStudy
        ...
        sections={[
...

          {
            ...
            archifySrc: "/flows/savee-anti-waste-loop.html",
            spec: {
              phases: [
                "1 · Watch",
                "2 · Save",
              ...
              nodes: [
                ...
                },
                {
                  ...
                  row: 2,
                  kind: "auto",
                  title: "Sized and listed",
                  sub: "portions scale it, aisle groups fold it in",
                },
                {
                  id: "shop",
                  col: 5,
              ...
              lanes: [
                { row: 1, label: "You" },
                { row: 2, label: "The app, automatically" },
              ],
              cards: [
                {
                  title: "No entry for impulse",
                  items: [
                    "The list only ever holds what a scheduled recipe asked for",
                    "An impulse buy has nowhere to enter the list",
                  ],
                },
                {
                  title: "Portions do the math",
                  items: [
                    "The stepper scales every quantity on the list",
                    "Cooking for two instead of four halves the shop",
                  ],
                },
              ],
            },

    ...
    <>
      ...
      sections={[
...

        {
          ...
          archifySrc: "/flows/taurus-before.html",
          spec: {
            phases: [
              "1 · New record",
              "2 · Add animal",
            ...
            lanes: [
              { row: 1, label: "The form, one animal at a time" },
              { row: 2, label: "The form, one animal at a time" },
              { row: 3, label: "The form, one animal at a time" },
              { row: 4, label: "Where it breaks" },
            ],
            cards: [
              {
                title: "One animal, one trip",
                items: [
                  "Six or seven fields, one save, repeat for every animal",
                  "A 70 head farm took the better part of a working day",
                ],
              },
              {
                title: "The cost of the loop",
                items: [
                  "Ranchers entered only the key animals and stopped",
                  "The data was never complete enough to trust",
                ],
              },
            ],
          },
...

        {
          ...
          archifySrc: "/flows/taurus-after.html",
          spec: {
            phases: [
              "1 · Paddock",
              "2 · Moving or new",
            ...
            nodes: [
              ...
              { id: "move", col: 2, row: 1, kind: "decision", title: "Moving animals you already have" },
              { id: "select", col: 3, row: 1, title: "Select them", sub: "they keep their history" },
              { id: "sheet", col: 3, row: 2, kind: "decision", title: "Import from a sheet" },
              {
                id: "newrows",
                col: 4,
                row: 1,
                kind: "auto",
                title: "Create and auto-fill",
                sub: "say how many, presets handle the repeats",
              },
              {
                id: "migrate",
                col: 4,
              ...
              { id: "add", col: 6, row: 1, kind: "end", title: "Add animals", sub: "the whole herd, one pass" },
            ],
            edges: [
              ...
              { from: "sheet", to: "newrows", label: "no" },
              { from: "select", to: "validate" },
              { from: "migrate", to: "validate" },
              { from: "newrows", to: "validate" },
              { from: "validate", to: "add" },
            ],
            lanes: [
              { row: 1, label: "The table" },
              { row: 2, label: "Already in a file" },
            ],
            cards: [
              {
                title: "One surface, three ways in",
                items: [
                  "Already tracked animals: select them, keep their history",
                  "Already in a spreadsheet: paste it, the sheet migrates",
                  "Brand new: presets and fill-down handle the repeats",
                ],
              },
              {
                title: "Validated before it lands",
                items: [
                  "Bad weights and duplicate tags flagged in the row, not after",
                  "100% of new farms and 98% of tracked farms now load this way",
                ],
              },
            ],
          },

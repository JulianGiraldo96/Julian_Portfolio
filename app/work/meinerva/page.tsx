            ...
            spec: {
              ...
              nodes: [
                ...
                },
                {
                  ...
                  sub: "a twenty second countdown starts, the screen goes quiet",
                },
                {
                  id: "look",
                  col: 2,
                  row: 3,
                  title: "Look at the actual thing",
                  sub: "the app has nothing to offer for twenty seconds",
                },
                {
                  id: "halftone",
                  col: 3,
                ...
                },
                {
                  ...
                  row: 1,
                  kind: "auto",
                  title: "It unlocks in full colour",
                  sub: "the reveal is earned, not given",
                },
                {
                  id: "layers",
                  col: 4,
                  row: 2,
                  title: "Hints and context open",
                  sub: "artist commentary, historical and cultural layers",
                },
                {
                  id: "community",
                  col: 4,
              ...
              edges: [
                { from: "scan", to: "dnd" },
                { from: "dnd", to: "look" },
                { from: "look", to: "halftone" },
                { from: "halftone", to: "write" },
                { from: "write", to: "colour", label: "submitted" },
                { from: "write", to: "halftone", label: "cancelled", dashed: true },
                { from: "colour", to: "layers" },
                { from: "layers", to: "community" },
              ],
            },
          },
